...
namespace BenueCommunityMapping.Pages.DataAnalysis.Questionnaire
{
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // If community name is provided, dynamically find or create the Community entity
            // This ensures submissions remain linked to the geographic hierarchy for Analytics
            if (!string.IsNullOrWhiteSpace(communityName))
            {
                ...
                else
                {
                    var newCommunity = new Community
                    {
                        ...
                        KindredId = kindredId, // This is now safely nullable to avoid DB errors
                        IsActive = true
                    };
            ...
            {
                submission = await _submissions.CreateDraftAsync(user.Id, user.CoordinatorId, communityId ?? 0);
            ...
            // Update community link and name
            submission.CommunityId   = communityId;
            submission.CommunityName = communityName;
